...
void main() {
  late GetAllNowPlayingTVShow getAllNowPlayingTvShow;
  late TvShowRepoMock tVShowRepositoryMock;

  setUp(() {
    tVShowRepositoryMock = TvShowRepoMock();
    getAllNowPlayingTvShow = GetAllNowPlayingTVShow(tVShowRepositoryMock);
  });
  ...
  test('should get list of TV Show from the repository', () async {
    // arrange
    when(tVShowRepositoryMock.getNowPlayingAllTVShow())
