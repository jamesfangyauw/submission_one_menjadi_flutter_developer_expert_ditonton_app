...
// in submission_one_menjadi_flutter_developer_expert_ditonton_app/test/presentation/pages/top_rated_movies_page_test.dart.
...
import 'package:submission_one_menjadi_flutter_developer_expert_ditonton_app/domain/usecases/get_all_top_rated_movies.dart' as _i2;
...
class _FakeGetTopRatedMovies extends _i1.Fake implements _i2.GetAllTopRatedMovies {
}
...
class MockTopRatedMoviesNotifier extends _i1.Mock
  ...
  @override
  _i2.GetAllTopRatedMovies get getTopRatedMovies =>
      (super.noSuchMethod(Invocation.getter(#getTopRatedMovies),
          returnValue: _FakeGetTopRatedMovies()) as _i2.GetAllTopRatedMovies);
  @override
  _i4.EnumStateRequest get state => (super.noSuchMethod(Invocation.getter(#state),
